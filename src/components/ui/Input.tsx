...
const BASE_CONTROL =
  'w-full min-h-11 px-3.5 py-2.5 text-base rounded-md bg-surface-muted border border-border-subtle ' +
  'text-text-primary placeholder:text-text-tertiary ' +
  'focus:outline-none focus:bg-surface-card focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 ' +
